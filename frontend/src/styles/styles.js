const styles = {
    ...
    heading: "text-[27px] text-center text-center md:text-start font-[600] font-Roboto pb-[20px]",
    ...
    activeStatus: "2-[10px] h-[10px] rounded-full absolute top-0 right-1 bg-[#40d132]",
